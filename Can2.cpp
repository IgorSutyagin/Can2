...
// Can2.cpp : Defines the class behaviors for the application.
//
...
CCan2App::CCan2App() noexcept
{
	...
	SetAppID(_T("Can2.AppID.NoVersion"));
...
BOOL CCan2App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_Can2TYPE,
